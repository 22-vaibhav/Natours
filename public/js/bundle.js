      ...
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            data: {
              email: email,
              // login API expects an email
              password: password // login API expects a password
            }
          });
        case 1:
          res = _context.v;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFpYmhhdi1wLTAxIiwiYSI6ImNtaHZpenJsdTA5ZnoyanFyNjF0NXhzc3UifQ.NBGTC8RrhphjURCgp5XVBg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/vaibhav-p-01/cmhvka1xv002v01s57qajh14u',
    scrollZoom: false
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    var url, res, updatedUser, navImg, formImg, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 1:
          ...
          if (type === 'data') {
            updatedUser = res.data.data.user; // this will instantly update photo in DOM
            navImg = document.querySelector('.nav__user-img');
            formImg = document.querySelector('.form__user-photo');
            if (navImg) navImg.src = "/img/users/".concat(updatedUser.photo);
            if (formImg) formImg.src = "/img/users/".concat(updatedUser.photo);
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51SU51AGvQja5HatPE4BYQFSrCEGixgcEiGdfxXd9gOXjYi1jKYbFFUOPPQeqDpOuS8CvU6UjcTMPZfK52eTPA9DO00WG3nSv5k');
